<x-guest-layout title='Ganti Password - Pondok Indonesia'>
    <div class='min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100'>
        <div class='w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg'>
            <div class='mb-4 text-center'>
                <h2 class='text-2xl font-bold text-gray-900'>Login Pertama</h2>
                <p class='text-sm text-gray-600'>Demi keamanan, silakan ganti password Anda.</p>
            </div>
            ...
            <form method='POST' action='{{ route('password.first-login.process') }}'>
                @csrf
